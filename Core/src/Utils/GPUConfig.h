...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            rgbStepMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(416, 16);
            rgbResMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(224, 464);
            so3StepMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(64, 64);
